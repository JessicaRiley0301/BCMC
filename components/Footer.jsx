...
const Footer = () => {
  return (
    <div id="footer">
     <section class="bg-bamboo w-screen ">
     <motion.div 
              ...
              viewport={{ once: true }}
              >
        <div class=" mx-auto p-8 border-t border-gray-400 max-w-6xl">

        <div class="table w-full">
        <div class="block sm:table-cell">
        <p class="font-playfair text-gray-700 text-2xl py-4">Contact</p>
        <p class="text-gray-700 hover:underline text-md py-2">
        <a href="tel:310458-1488">(310) 458-1788
        </a>
        </p>
        <p class="text-gray-700 hover:underline text-md py-2"><a href="mailto:baolinwu.medicalcenter@gmail.com">baolinwu.medicalcenter@gmail.com</a></p>
        <div>
            <p class="font-playfair text-gray-700 text-2xl py-4">Hours</p>
            <p class="text-gray-700 text-md py-2">
        ...
        <div class="block sm:table-cell">
            <p class="font-playfair text-gray-700 text-2xl py-4">Location</p>
            <div>
            <p class="text-gray-700 text-md py-2">
        ...
        <div class="flex pb-5 px-3 m-auto pt-5 border-t border-gray-400 text-grey-700 text-sm 
    ...
    <a href="https://www.pinterest.com/beijingchinesemedicalcenter/_created/" class="w-6 mx-1">
            <i class="uil uil-pinterest-alt"></i>
            <svg
        ...
        <a href="https://www.facebook.com/BeijingChineseMedicalCenter/" class="w-6 mx-1">
            <svg
