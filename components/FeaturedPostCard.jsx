...
const FeaturedPostCard = ({ post }) => (
  ...
  <div className="relative h-72 m-2">
    <div className="absolute  bg-center bg-no-repeat bg-cover shadow-md inline-block w-full h-72" style={{ backgroundImage: `url('${post.coverImage.url}')` }} />
