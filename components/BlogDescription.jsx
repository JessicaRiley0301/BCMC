  ...
  return (
    <div className="bg-bamboo w-screen bg-cover bg-fixed mx-auto p-4 md:px-10 md:py-8">
        <div className="bg-white bg-opacity-80 shadow-lg w-full content-center inline-block border-green-700 p-8">
            ...
            <p className="text-center text-md md:px-16">
                ...
                <p className="text-center text-md md:px-16 md:py-4">
                ...
                <div className="flex relative flex-col md:flex-row items-center -mx-2 justify-content-center">
                    ...
                    <Image alt="chinesezodiac" className="max-w-full rounded-lg shadow-lg" src={chinesezodiac}/>
                    </div>
                    <div className="md:w-1/3 px-2">
                    ...
                    <Image alt="solarterm" className="max-w-full rounded-lg shadow-lg" src={solarterm}/>
                    </div>
                    <div className="md:w-1/3 px-2">
                    ...
                    <Image alt="clock" className="max-w-full rounded-lg shadow-lg" src={clock}/>
                    </a>
                    </div>
                </div>
            </div>
