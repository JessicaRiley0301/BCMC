...
const HeaderStore = () => {
  return (
    ...
    <motion.div 
              ...
              viewport={{ once: true }}
              >
    <h3 className="font-playfair p-4 font-extrabold text-black text-6xl md:text-6xl text-center">Shop Our Store</h3>
    <h5 className="p-4 font-extrabold text-gray-600 text-2xl md:text-3xl text-center">Shop Best-Selling Books. Herbs (Coming Soon).</h5>
    </motion.div>
