          ...
          <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
            <div className="w-full lg:w-1/2 px-4 py-2">
              <details className="mb-4">
                ...
                <span>
                Qi Gong is breath. The discipline of Qi Gong teaches how to breathe, to cleanse and detoxify the body. It is the key for maintaining health and to recover quickly from sickness. You can live without food and water for many days, but only 5 minutes without breathing. That's why Qi Gong is more important than knowing how many vitamins to take...
                The Daoists observed nature and the communication between breathing and the Universe, how through breathing we can receive help from nature through the plants, the Earth, the Sun... It is a proven fact that turtles live the longest of any creature on Earth. The Daoists observed the way turtles breathe, and they taught how to imitate their breathing to achieve longevity.
                Qi Gong studies three kinds of breathing: the breathing you are all familiar with, through your nose and mouth, as well as abdominal breathing and breathing through every pore of the skin. From the macro point of view, you breathe in and out through your nose and mouth, but from the micro point of view, you breathe in and out with the universe. Observe nature on a smaller and smaller scale, go smaller than the atom, and you still find an exchange of breath going on. Without breath, there is no life.
                Birth and death are processes of Qi, or breathing. Qi is created by any interaction with and by any adjustment to the universe all around you. We wear more clothes when it gets cold, we drink when thirsty, we sleep when tired... we need to adjust to any and all changes in the natural world in order to survive. Knowledge of Qi Gong makes you able to adjust also to those aspects of nature, which are not so easy to observe. This ability to adjust promotes longevity.
              ...
              <details className="mb-4">
                ...
                <span>
                Qi Gong belongs to China's ancient culture, but not many have studied it. The Daoists did. Qi Gong originated with Daoism 5000 years ago, and the White Cloud Monastery, where Daoist thinking and its origins have been preserved, has been the leader in Qi Gong training throughout its 1000 year long history. Harvard, Yale, or other top Western universities cannot claim such a historical leadership in any field. There are not many advanced Qi Gong Masters from the White Cloud Monastery, and beside myself they all now live in China, though this may change.
              ...
              <details className="mb-4">
                ...
                <span>
                Between the hours of 7 and 9 either in the a.m. or p.m. stand in a comfortable position with your feet shoulder width apart. You may be indoors or outdoors. Close your eyes. Imagine drawing your eyes down to the soles of your feet, and with your awareness there, breathe evenly and slowly for five minutes. This technique will improve your eyesight, increase your memory, lower blood pressure and alleviate insomnia. Remember, an important part of Qi Gong is not to go to extremes. Do everything with moderation. Eat to half full, nothing too hot or spicy. Avoid excessive feelings, even excitement. Keep your feet warm. Keep your head cool. These are basic requirements of Qi Gong.
            ...
            <div className="w-full lg:w-1/2 px-4 py-2">
              ...
              <details className="mb-4">
                ...
                It enhances the immune system in order to prevent cancer, heart and cerebral diseases. It restores your energy and is effective on weakness, allergies, all kinds of pains and other immune system diseases.
                It adjusts all of your internal systems to help digestion. Practicing Qi Gong has another benefit as well. You release good Qi for others, for the trees, for all of nature, so that you help bring balance to the world. Like the breath, which Qi Gong is, there is a mutual exchange, which benefits all of life.
