...
const HeaderFAQ = () => {
  return (
    ...
    <motion.div 
              ...
              viewport={{ once: true }}
              >
    <h3 className="font-playfair p-4 font-extrabold text-black text-4xl md:text-5xl text-center">Frequently Asked Qustions</h3>
    <h5 className=" p-4 font-extrabold text-gray-600 text-2xl text-center p-4">Common Questions and Concerns about Acupuncture, Qi Gong, and More</h5>
    </motion.div>
